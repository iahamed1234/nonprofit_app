...
SECRET_KEY = 'django-insecure-pjg$jb$yxd=j(@it!ehor4w96w=nlxw!44kd8iz+ould-%r2&#'
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware', # Call Django backend from frontend
]
